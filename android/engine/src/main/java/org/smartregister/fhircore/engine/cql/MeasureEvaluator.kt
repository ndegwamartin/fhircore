...
class MeasureEvaluator {
   ...
   */
  private fun setup(patientResources: ArrayList<IBaseResource> = ArrayList(),
                    library: IBaseBundle,fhirContext:FhirContext) {

    val bundleFactory = fhirContext.newBundleFactory()!!
    bundleFactory.addRootPropertiesToBundle("bundled-directory", bundleLinks, patientResources.size, null)
